...
import { NetworkCTA, network, provider, providerCTA } from "@/lib/NavRoutes";
  ...
  return (
    ...
    >
      ...
      <div className="flex-auto">
        <Popover.Button
          as={asComponent}
          className="block font-semibold text-gray-900 dark:text-white font-inter"
        >
          {item.name}
    ...
    <header className="relative isolate bg-golemmain text-white z-50">
      ...
      >
        ...
        <div className="flex gap-x-8 items-center">
          <Link
            href={"/"}
            className="hidden lg:flex font-semibold leading-6 text-white"
          >
            Network
          </Link>
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-[55] w-full overflow-y-auto bg-golemmain dark:bg-gray-800 text-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
