...
const GpuPerformanceChart = ({ nodeId }) => {
    const { data, isValidating } = useSWR(`stats/benchmark/gpu/${nodeId}`, (url) => fetcher(url, { useReputationApi: true }), {})
    ...
    return (
        <Card className="p-0 h-full">
            <div className="p-6">
                <h3 className="font-medium text-tremor-content-strong dark:text-dark-tremor-content-strong">GPU Performance</h3>
                <p className="text-tremor-default leading-6 text-tremor-content dark:text-dark-tremor-content">
                    This chart presents the results of GPU benchmark tests, focusing on performance in GFLOPS (giga floating-point
                ...
                {isValidating ? (
                    ...
                    <>
                            ...
                            <ul role="list" className="flex flex-wrap items-center gap-x-6 gap-y-4">
                                <li className="flex items-center space-x-2">
                                    ...
                                    <p className="text-tremor-default text-tremor-content dark:text-dark-tremor-content">
                                        GPU Score: <span className="font-semibold">{latestScore}</span>
                                    </p>
                                </li>
                            </ul>
                        ...
                        <AreaChart
                            data={formattedData}
                            index="date"
                            noDataText="No GPU data yet. Please check back later."
