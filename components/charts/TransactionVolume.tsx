...
export const TxVolumeAnalysis = () => {
    const [selectedTimeFrame, setSelectedTimeFrame] = useState("1y")
    const { data, error, isValidating } = useSWR("v2/network/transactions/volume", fetcher, {})
    ...
    return (
        <Card className="h-full px-6">
            <div className="px-6 mb-6">
                <h1 className="text-2xl mb-2 font-medium dark:text-gray-300">Daily Transaction Count</h1>
                <p className="text-tremor-default text-tremor-content dark:text-dark-tremor-content">
                    This chart visualizes the daily transaction volume on the Golem Network compared to those processed directly on the
                    Polygon blockchain. The size of each area represents the total amount of GLM transactions for each category on a given
                    day.
                </p>
            </div>
