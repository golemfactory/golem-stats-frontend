    ...
    return (
        <div className="bg-white dark:bg-gray-800 pt-5 px-4 sm:px-6 shadow rounded-lg h-full">
            <div className="relative">
                ...
                <h3 className="text-2xl mb-2 font-medium dark:text-gray-300">Market Agreement Outcome (1h)</h3>
                <span className="text-gray-500 dark:text-gray-400">
                    ...
                    <a
                        ...
                        rel="noreferrer"
                    >
                        <span className="text-tremor-brand-golemblue dark:text-dark-tremor-brand-golemblue dark:text-gray-300"> here</span>
                    </a>
                </span>
            </div>
            <ApexChart type="donut" className="py-6" width="100%" height="250" options={chartOptions} series={series} />
        </div>
    )
}
